                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-footer">
                                    ...
                                    <div class="footer-logo">
                                        <a href="index.html"><img  src="../../../../../public/frontend/img/logo/logo2.png" alt=""></a>
                                    </div>
                                    <!--Footer Logo End-->
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="single-footer mt-30">
                                    ...
                                    <div class="footer-content">
                                        <a href="#"><img  src="../../../../../public/frontend/img/apps/1.jpg" alt=""></a>
                                        <a href="#"><img  src="../../../../../public/frontend/img/apps/2.jpg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <!--Single Footer End-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 text-center">
                                    <div class="news-lettar-content">
                                        <div class="icon">
                                            <img  src="../../../../../public/frontend/img/icon/5.png" alt="">
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="copyright-text">
                                    <!-- <p>Copyright © <script>document.write(new Date().getFullYear());</script> <a href="../../index.htm" target="_blank">Hastech</a>, All Rights Reserved.</p> -->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="payment-img text-right">
                                    <a href="#"><img  src="../../../../../public/frontend/img/payment/payment.png" alt=""></a>
                                </div>
                            </div>
